...
public class ModelAnimator2 extends ModelBase
{
    ...
    public ModelAnimator2()
    {
        ...
        setTextureOffset("Frame.Top2", 0, 0);
        setTextureOffset("Frame.Base", 0, 0);
        setTextureOffset("Frame.Base2", 0, 0);
        setTextureOffset("Cage.Bar1", 0, 0);
        setTextureOffset("Cage.Bar2", 0, 0);
        setTextureOffset("Cage.Bar3", 0, 0);
        setTextureOffset("Cage.Bar4", 0, 0);
        setTextureOffset("Cage.Bar5", 0, 0);
        setTextureOffset("Cage.Bar6", 0, 0);
        setTextureOffset("Cage.Bar7", 0, 0);
        setTextureOffset("Cage.Bar8", 0, 0);
        setTextureOffset("Orb.Orb1", 0, 0);
        setTextureOffset("Orb.Orb2", 0, 0);
